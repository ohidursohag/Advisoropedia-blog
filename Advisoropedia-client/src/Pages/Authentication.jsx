  ...
  return (
    <Container className={"flex justify-center items-center min-h-screen"}>
      <div className="w-[340px] sm:w-[500px] md:w-[750px] lg:w-[800px] mx-auto bg-white flex items-center relative overflow-hidden shadow-xl">
        ...
        `}>
          <div
            className={`absolute -bottom-2 h-16 w-16 rounded-full bg-gradient-to-br duration-500  from-white via-[#9eb6f8] to-[#6585dd] ${
              register ? "-translate-x-[100%]" : "translate-x-[100%] "
            }`}
          />
          <div
            className={`absolute -top-2 h-16 w-16 rounded-full bg-gradient-to-br duration-500  from-white via-[#9eb6f8] to-[#6585dd] ${
              register ? "-translate-x-[100%]" : "translate-x-[100%] "
            }`}
          />
          <div
            className={`absolute  h-14 w-14 top-[50%] -translate-y-1/2 rounded-full bg-gradient-to-br from-white via-[#9eb6f8] to-[#6585dd] transition-all duration-500 ${
